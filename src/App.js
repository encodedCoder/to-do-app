...
function App() {
  ...
  const [renderList, setRenderList] = React.useState("all");
    ...
    <div className="app">
      <div className="container">
        <main className="flex items-center justify-center min-h-screen bg-gray-300">
          ...
          <h5 className="text-center">by encodedcoder · Suresh</h5>
          <StatusBar
        ...
        <footer className="footer">
          <div className="container mx-auto text-center p-4 content-width">
